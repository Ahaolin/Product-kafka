...
public class CLHLock {
    ...
    private static final ThreadLocal<String> LOCAL_STRING = new ThreadLocal<String>();
    ...
    public static void main(String[] args) {
        ...
        executorService.execute(() -> {
            ...
            LOCAL_STRING.set("线程1");
            LOCAL_STRING.set("线程1-A");
        });

        executorService.execute(() -> {
            Thread.currentThread().setName("线程2");
            LOCAL_STRING.set("线程2");
            LOCAL_STRING.set("线程2-A");
        });
