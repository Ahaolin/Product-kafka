 ...
 * @author MSI
 * 生产者拦截器示例
 *  ProducerInterceptorSupperPrefix {@link ProducerInterceptorPrefix} 前缀不同
 */
public class ProducerInterceptorSupperPrefix implements ProducerInterceptor<String, String> {
